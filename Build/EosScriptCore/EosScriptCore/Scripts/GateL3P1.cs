...
{
    public class GateL3P1 : MonoBase
    {
        ...
        private Color pos1, pos2, pos3, pos4;
        ...
        void OnStart()
        {
            gateFence = gameObject.FindWithTag("Gate03_Fence");
            gateCollider = gameObject.FindWithTag("FenceCollider03");
