...
{
	public class BridgeInputL3P1 : MonoBase
	{
		List<VirusScript> inputs = new List<VirusScript>();
		
		public BridgeSourceL3P1 linkedBridge;
		...
		void UpdateBridge()
		{
			...
			BridgeSourceL3P1.globalController.BuildBridge(colorList);
		}
