...
namespace EosScriptCore.Scripts
{
    public class Gate1 : MonoBase
    {
        ...
        void OnStart()
        {
            gateFence = gameObject.FindWithTag("Gate_Fence01");
            gateCollider = gameObject.FindWithTag("Gate01_Gate_Collider");
