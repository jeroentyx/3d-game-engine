...
namespace Eos
{
	...
	* 
	* 
	*  Some of the flags used in assimp for model parsing for easier prototyping
	* 
	* 
	*/
	...
	inline ParserFlags operator~ (ParserFlags a) { return (ParserFlags)~(int)a; }
	inline ParserFlags operator| (ParserFlags a, ParserFlags b) { return (ParserFlags)((int)a | (int)b); }
	inline ParserFlags operator& (ParserFlags a, ParserFlags b) { return (ParserFlags)((int)a & (int)b); }
	inline ParserFlags operator^ (ParserFlags a, ParserFlags b) { return (ParserFlags)((int)a ^ (int)b); }
	inline ParserFlags& operator|= (ParserFlags& a, ParserFlags b) { return (ParserFlags&)((int&)a |= (int)b); }
	inline ParserFlags& operator&= (ParserFlags& a, ParserFlags b) { return (ParserFlags&)((int&)a &= (int)b); }
